...
<body>
	<div id="wrapper">
		...
		<div id="page-wrapper">
			<div class="row">
				<div class="col-lg-12">
					<h1 class="page-header">Zones de croisement</h1>
	...
	function ajouter() {
	    $.ajax({
	    	url: "/alize/nau/zonesdecroisement/ajouter",
	    	type: "POST",
	    	success: function(str) {
	    		get();
	    	}
	...
	function supprimer(id) {
	    ...
	    $.ajax({
	    	url: "/alize/nau/zonesdecroisement/supprimer",
	    	data: "id=" + id,
	    	type: "POST",
	    	success: function(str) {
	    		get();
	...
	function updateCellValue(editableGrid, rowIndex, columnIndex, oldValue, newValue, row, onResponse)
	{
		...
		$.ajax({
			url: '/alize/nau/zonesdecroisement/update',
			type: 'POST',
	    	data: "id=" + id + 
	    		"&newvalue=" + newvalue + 
   				"&colname=" + colname,
